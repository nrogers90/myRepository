...
document.getElementById("person").innerHTML = personJSON;

// json.parse()
let personString = '{"firstName":"Nick","lastName":"Rogers","age":35}';

let obj = JSON.parse(personString);

document.getElementById("parsedPerson").innerHTML =
...
function show() {
    ...
    var html = '<ul>';
    /*This diplays a task to the list in the order that it is inputed*/
